# Frontend ↔️ Backend API Contract
...
## 🔐 Teacher authentication & classroom preparation
...
## 🎮 Player onboarding & gameplay loop
...
- **Response** `200`
  ```json
  {
    ...
    "scenarioText": "You're starting university in a new city, you need to find an affordable apartment and balance study/work — explain your first steps and priorities."
  }
  ```
...
- **Request body**
  ...
  {
    "studentId": "stud_19ab",
    "message": "I'd start by searching student housing groups and set a €600 rent budget.",
    "scenarioId": "scn_b58c3d72-1e8a-4af5-a0c6-c0ef987ad123",
...
Expose an individual’s narrative insight plus structured highlights so the UI can show a compelling recap card.
- **Response** `200`
  ```json
  {
    "studentId": "stud_19ab",
